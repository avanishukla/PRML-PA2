...
sigma_cal = zeros(1 , 2) ;
for i = 1:250
   sigma_cal(1,1) =  sigma_cal(1,1) + (AM1(i,1) - mean1(1,1))^2 + (AM2(i,1) - mean2(1,1))^2 ; %+ (AM3(i,1) - mean3(1,1))^2 ;
   sigma_cal(1,2) =  sigma_cal(1,2) + (AM1(i,2) - mean1(2,1))^2 + (AM2(i,2) - mean2(2,1))^2 ; %+ (AM3(i,2) - mean3(2,1))^2; 
end

sigma_cal = sigma_cal / 500 ;
sigma_square = mean(sigma_cal);
mn = (mean1(1,1) - mean1(2,1))^2 ;
sigma_square = 100000 ;
%%%%%%%%%%%5
p_data_val1_given_cls = zeros(150,4);
...
ans_val1 = zeros(150,2);

for i= 1:150
    ans_val1(i,1) =   (p_data_val1_given_cls(i,1)*p_data_val1_given_cls(i,2)) /2 ;
    ans_val1(i,2)=   (p_data_val1_given_cls(i,3)*p_data_val1_given_cls(i,4)) /2 ;
end
...
for i = 1 :150
    label_count = max(ans_val1(i,1),ans_val1(i,2));
...
p_data_val2_given_cls = zeros(150,4);
...
ans_val2 = zeros(150,2);

for i= 1:150
    ans_val2(i,1) =  (p_data_val2_given_cls(i,1)*p_data_val2_given_cls(i,2)) /2 ;
    ans_val2(i,2)=   (p_data_val2_given_cls(i,3)*p_data_val2_given_cls(i,4)) /2 ;
end

calculated_label_val_c2 = zeros(150,1) ;
for i = 1 :150
    label_count = max(ans_val2(i,1),ans_val2(i,2));
...
test_c3 = vec2mat(fscanf(fileID,'%f') , 2);
fclose(fileID);
%}
p_data_test1_given_cls = zeros(150,4);
...
ans_test1 = zeros(100,2);

for i= 1:100
    ans_test1(i,1) =   (p_data_test1_given_cls(i,1)*p_data_test1_given_cls(i,2)) /2 ;
    ans_test1(i,2)=   (p_data_test1_given_cls(i,3)*p_data_test1_given_cls(i,4)) /2 ;
...
for i = 1 :100
    label_count = max(ans_test1(i,1),ans_test1(i,2));
...
p_data_test2_given_cls = zeros(100,4);
for i = 1:100
...
ans_test2 = zeros(100,2);

for i= 1:100
    ans_test2(i,1) =  (p_data_test2_given_cls(i,1)*p_data_test2_given_cls(i,2)) /2 ;
    ans_test2(i,2)=   (p_data_test2_given_cls(i,3)*p_data_test2_given_cls(i,4)) /2 ;
   % ans_test2(i,3)=   (p_data_test2_given_cls(i,5)*p_data_test2_given_cls(i,6)) /3 ;
end
calculated_label_test_c2 = zeros(100,1) ;
for i = 1 :100
    label_count = max(ans_test2(i,1),ans_test2(i,2));
...
p_data_train1_given_cls = zeros(250,4);
count = 0 ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% testtttttttttttttttttt
for i = 1:250
...
ans_train1 = zeros(250,2);

for i= 1:250
    ans_train1(i,1) =  (p_data_train1_given_cls(i,1)*p_data_train1_given_cls(i,2)) /2 ;
    ans_train1(i,2)=   (p_data_train1_given_cls(i,3)*p_data_train1_given_cls(i,4)) /2;
...
for i = 1 :250
    label_count = max(ans_train1(i,1),ans_train1(i,2));
...
disp(count) ;
count = 0 ;
p_data_train2_given_cls = zeros(250,4);
for i = 1:250
...
ans_train2 = zeros(250,2);

for i= 1:250
    ans_train2(i,1) =  (p_data_train2_given_cls(i,1)*p_data_train2_given_cls(i,2)) /2 ;
    ans_train2(i,2)=   (p_data_train2_given_cls(i,3)*p_data_train2_given_cls(i,4)) /2 ;
  %  ans_train2(i,3)=   (p_data_train2_given_cls(i,5)*p_data_train2_given_cls(i,6)) /3 ;
end

calculated_label_train_c2 = zeros(250,1) ;
for i = 1 :250
    label_count = max(ans_train2(i,1),ans_train2(i,2));
...
%{
count = 0 ;
p_data_train3_given_cls = zeros(250,4);
for i = 1:250
...
count = 0 ;
p_plot_data = zeros(total_plot_data,4);
...
ans_plot_data = zeros(total_plot_data,2);

for i= 1:total_plot_data
    ans_plot_data(i,1) =  (p_plot_data(i,1)*p_plot_data(i,2)) /2 ;
    ans_plot_data(i,2)=   (p_plot_data(i,3)*p_plot_data(i,4)) /2 ;
    %ans_plot_data(i,3)=   (p_plot_data(i,5)*p_plot_data(i,6)) /3 ;
    
    label_count = max(ans_plot_data(i,1),ans_plot_data(i,2));
...
xlabel('x1')
ylabel('x2')
str  = { strcat('naive bayes sigma sq non')};
