...
cov_matrix_with_off_dia_zero3 = zeros(2,2);
...
for i = 1:2 
    ...
    if i==j
        ...
        cov_matrix_with_off_dia_zero3(i,j) = cov_mat3(i,j);
    end
    end
end
...
for i=1:150 
    x1(1,1) = val1(i,1)-mean1(1,1);
    x1(2,1) = val1(i,2)-mean1(2,1) ;
    probab_val1_c1(i,1)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero1)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero1)) );
    
    x1(1,1) = val1(i,1)-mean2(1,1);
    x1(2,1) = val1(i,2)-mean2(2,1) ;
    probab_val1_c1(i,2)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero2)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero2)) );
    
    x1(1,1) = val1(i,1)-mean3(1,1);
    x1(2,1) = val1(i,2)-mean3(2,1) ;
    probab_val1_c1(i,3)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero3)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero3)) );
end
...
for i = 1:150
 %valid 2
    x1(1,1) = val2(i,1)-mean1(1,1);
    x1(2,1) = val2(i,2)-mean1(2,1) ;
    probab_val1_c2(i,1)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero1)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero1)) );
    
    x1(1,1) = val2(i,1)-mean2(1,1);
    x1(2,1) = val2(i,2)-mean2(2,1) ;
    probab_val1_c2(i,2)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero2)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero2)) );
    
    x1(1,1) = val2(i,1)-mean3(1,1);
    x1(2,1) = val2(i,2)-mean3(2,1) ;
    probab_val1_c2(i,3)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero3)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero3)) );
end
...
for i = 1:150
 %valid 2
    x1(1,1) = val3(i,1)-mean1(1,1);
    x1(2,1) = val3(i,2)-mean1(2,1) ;
    probab_val1_c3(i,1)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero1)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero1)) );
    
    x1(1,1) = val3(i,1)-mean2(1,1);
    x1(2,1) = val3(i,2)-mean2(2,1) ;
    probab_val1_c3(i,2)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero2)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero2)) );
    
    x1(1,1) = val3(i,1)-mean3(1,1);
    x1(2,1) = val3(i,2)-mean3(2,1) ;
    probab_val1_c3(i,3)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero3)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero3)) );
end
disp(count);
count = 0;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% testtttttttttttttttttt c1
for i = 1:100
    x1(1,1) = test_c1(i,1)-mean1(1,1);
    x1(2,1) = test_c1(i,2)-mean1(2,1) ;
    probab_test1_given_class(i,1)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero1)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero1)) );
    
    x1(1,1) = test_c1(i,1)-mean2(1,1);
    x1(2,1) = test_c1(i,2)-mean2(2,1) ;
    probab_test1_given_class(i,2)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero2)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero2)) );
    
    x1(1,1) = test_c1(i,1)-mean3(1,1);
    x1(2,1) = test_c1(i,2)-mean3(2,1) ;
    probab_test1_given_class(i,3)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero3)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero3)) );
...
for i = 1:100
    x1(1,1) = test_c2(i,1)-mean1(1,1);
    x1(2,1) = test_c2(i,2)-mean1(2,1) ;
    probab_test2_given_class(i,1)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero1)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero1)) );
    
    x1(1,1) = test_c2(i,1)-mean2(1,1);
    x1(2,1) = test_c2(i,2)-mean2(2,1) ;
    probab_test2_given_class(i,2)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero2)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero2)) );
    
    x1(1,1) = test_c2(i,1)-mean3(1,1);
    x1(2,1) = test_c2(i,2)-mean3(2,1) ;
    probab_test2_given_class(i,3)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero3)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero3)) );   
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% testtttttttttttttttttt class 3
for i = 1:100
    x1(1,1) = test_c3(i,1)-mean1(1,1);
    x1(2,1) = test_c3(i,2)-mean1(2,1) ;
    probab_test3_given_class(i,1)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero1)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero1)) );
    
    x1(1,1) = test_c3(i,1)-mean2(1,1);
    x1(2,1) = test_c3(i,2)-mean2(2,1) ;
    probab_test3_given_class(i,2)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero2)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero2)) );
    
    x1(1,1) = test_c3(i,1)-mean3(1,1);
    x1(2,1) = test_c3(i,2)-mean3(2,1) ;
    probab_test3_given_class(i,3)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero3)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero3)) );
...
for i = 1:250
    x1(1,1) = AM1(i,1)-mean1(1,1);
    x1(2,1) = AM1(i,2)-mean1(2,1) ;
    probab_train1_given_class(i,1)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero1)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero1)) );
    
    x1(1,1) = AM1(i,1)-mean2(1,1);
    x1(2,1) = AM1(i,2)-mean2(2,1) ;
    probab_train1_given_class(i,2)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero2)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero2)) );
    
    x1(1,1) = AM1(i,1)-mean3(1,1);
    x1(2,1) = AM1(i,2)-mean3(2,1) ;
    probab_train1_given_class(i,3)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero3)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero3)) );   
end
...
for i = 1:250
    x1(1,1) = AM2(i,1)-mean1(1,1);
    x1(2,1) = AM2(i,2)-mean1(2,1) ;
    probab_train2_given_class(i,1)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero1)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero1)) );
    
    x1(1,1) = AM2(i,1)-mean2(1,1);
    x1(2,1) = AM2(i,2)-mean2(2,1) ;
    probab_train2_given_class(i,2)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero2)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero2)) );
    
    x1(1,1) = AM2(i,1)-mean3(1,1);
    x1(2,1) = AM2(i,2)-mean3(2,1) ;
    probab_train2_given_class(i,3)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero3)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero3)) );   
end
...
for i = 1:250
    x1(1,1) = AM3(i,1)-mean1(1,1);
    x1(2,1) = AM3(i,2)-mean1(2,1) ;
    probab_train3_given_class(i,1)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero1)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero1)) );
    
    x1(1,1) = AM3(i,1)-mean2(1,1);
    x1(2,1) = AM3(i,2)-mean2(2,1) ;
    probab_train3_given_class(i,2)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero2)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero2)) );
    
    x1(1,1) = AM3(i,1)-mean3(1,1);
    x1(2,1) = AM3(i,2)-mean3(2,1) ;
    probab_train3_given_class(i,3)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero3)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero3)) );
...
for i=1:total_plot_data 
    ...
    probab_plot(i,3)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero3)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero3)) );
