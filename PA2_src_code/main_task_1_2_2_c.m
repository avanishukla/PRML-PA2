...
for i=1:150 
    ...
    probab_val1_c1(i,3)= (exp(-0.5 * x'*inv(cov_matrix_with_off_dia_zero)*x ) / sqrt(det(cov_matrix_with_off_dia_zero)) );
end
...
for i = 1:150
 %valid 2
    ...
    probab_val1_c2(i,3)= (exp(-0.5 * x'*inv(cov_matrix_with_off_dia_zero)*x ) / sqrt(det(cov_matrix_with_off_dia_zero)) );
end
...
for i = 1:150
 %valid 2
    ...
    probab_val1_c3(i,1)= (exp(-0.5 * x'*inv(cov_matrix_with_off_dia_zero)*x ) / sqrt(det(cov_matrix_with_off_dia_zero)) );
    
    x(1,1) = val3(i,1)-mean2(1,1);
    x(2,1) = val3(i,2)-mean2(2,1) ;
    probab_val1_c3(i,2)= (exp(-0.5 * x'*inv(cov_matrix_with_off_dia_zero)*x ) / sqrt(det(cov_matrix_with_off_dia_zero)) );
    
    x(1,1) = val3(i,1)-mean3(1,1);
    x(2,1) = val3(i,2)-mean3(2,1) ;
    probab_val1_c3(i,3)= (exp(-0.5 * x'*inv(cov_matrix_with_off_dia_zero)*x ) / sqrt(det(cov_matrix_with_off_dia_zero)) );
end
disp(count);
count = 0;
...
for i = 1:100
    ...
    probab_test1_given_class(i,3)= (exp(-0.5 * x'*inv(cov_matrix_with_off_dia_zero)*x ) / sqrt(det(cov_matrix_with_off_dia_zero)) );
...
for i = 1:100
    ...
    probab_test2_given_class(i,3)= (exp(-0.5 * x'*inv(cov_matrix_with_off_dia_zero)*x ) / sqrt(det(cov_matrix_with_off_dia_zero)) );   
end
...
for i = 1:100
    ...
    probab_test3_given_class(i,1)= (exp(-0.5 * x'*inv(cov_matrix_with_off_dia_zero)*x ) / sqrt(det(cov_matrix_with_off_dia_zero)) );
    
    x(1,1) = test_c3(i,1)-mean2(1,1);
    x(2,1) = test_c3(i,2)-mean2(2,1) ;
    probab_test3_given_class(i,2)= (exp(-0.5 * x'*inv(cov_matrix_with_off_dia_zero)*x ) / sqrt(det(cov_matrix_with_off_dia_zero)) );
    
    x(1,1) = test_c3(i,1)-mean3(1,1);
    x(2,1) = test_c3(i,2)-mean3(2,1) ;
    probab_test3_given_class(i,3)= (exp(-0.5 * x'*inv(cov_matrix_with_off_dia_zero)*x ) / sqrt(det(cov_matrix_with_off_dia_zero)) );
...
for i = 1:250
    ...
    probab_train1_given_class(i,3)= (exp(-0.5 * x'*inv(cov_matrix_with_off_dia_zero)*x ) / sqrt(det(cov_matrix_with_off_dia_zero)) );   
end
...
for i = 1:250
    ...
    probab_train2_given_class(i,3)= (exp(-0.5 * x'*inv(cov_matrix_with_off_dia_zero)*x ) / sqrt(det(cov_matrix_with_off_dia_zero)) );   
end
...
for i = 1:250
    ...
    probab_train3_given_class(i,1)= (exp(-0.5 * x'*inv(cov_matrix_with_off_dia_zero)*x ) / sqrt(det(cov_matrix_with_off_dia_zero)) );
    
    x(1,1) = AM3(i,1)-mean2(1,1);
    x(2,1) = AM3(i,2)-mean2(2,1) ;
    probab_train3_given_class(i,2)= (exp(-0.5 * x'*inv(cov_matrix_with_off_dia_zero)*x ) / sqrt(det(cov_matrix_with_off_dia_zero)) );
    
    x(1,1) = AM3(i,1)-mean3(1,1);
    x(2,1) = AM3(i,2)-mean3(2,1) ;
    probab_train3_given_class(i,3)= (exp(-0.5 * x'*inv(cov_matrix_with_off_dia_zero)*x ) / sqrt(det(cov_matrix_with_off_dia_zero)) );
...
for i= 1: total_plot_data
    ...
    probab_plot(i,3)= (exp(-0.5 * x1'*inv(cov_matrix_with_off_dia_zero)*x1 ) / sqrt(det(cov_matrix_with_off_dia_zero)) );
...
xlabel('x1')
ylabel('x2')
str  = { strcat('Decision Region Plot naive bayes same cov overlapping ')};
